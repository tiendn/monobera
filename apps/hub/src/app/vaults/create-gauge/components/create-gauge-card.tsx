    ...
    if (targetAddress) {
      ...
      const mockFetchVaultInfo = () => {
        if (targetAddress === "0x79f453D56C4bC66586215827FbBc7B34Bc006b33") {
          ...
          targetAddress === "0xb73deE52F38539bA854979eab6342A60dD4C8c03"
        ) {
          setVaultInfo({
            name: "HONEY-USDC",
            totalSupply: "10 Mln",
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-1">
              ...
              <Tooltip
                className="ml-1"
                text="The total supply of the Reward Vault"
              />
            </label>
            ...
            <div className="flex items-center">
              {vaultInfo ? (
                <>
                  ...
                  {vaultInfo.status === "Available" && (
                    <Icons.checkCircle className="h-4 w-4 text-green-500 ml-1" />
                  )}
                  {vaultInfo.status === "Already exists" && (
                    <Icons.xCircle className="h-4 w-4 text-red-500 ml-1" />
                  )}
                </>
              ) : (
                <span>—</span>
