export const BGT_ABI = [
  ...
  {
    type: "function",
    name: "activateCommissionChangeDelay",
    inputs: [],
    outputs: [{ name: "", type: "uint32", internalType: "uint32" }],
    stateMutability: "view",
  },
  ...
  },
  {
    ...
    name: "commissions",
    inputs: [{ name: "pubkey", type: "bytes", internalType: "bytes" }],
    outputs: [{ name: "rate", type: "uint224", internalType: "uint224" }],
    stateMutability: "view",
  },
  {
    type: "function",
  ...
  },
  {
    ...
    inputs: [
      { name: "_activateBoostDelay", type: "uint32", internalType: "uint32" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
    type: "function",
    name: "setActivateCommissionChangeDelay",
    inputs: [
      {
        name: "_activateCommissionChangeDelay",
        type: "uint32",
        internalType: "uint32",
      },
    ],
  ...
  },
  {
    ...
    inputs: [
      { name: "_dropBoostDelay", type: "uint32", internalType: "uint32" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  {
    type: "event",
    name: "ActivateCommissionChangeDelayChanged",
    inputs: [
      {
        name: "newDelay",
        type: "uint32",
  ...
  { type: "error", name: "InvalidActivateCommissionChangeDelay", inputs: [] },
  ...
  { type: "error", name: "MaxNumWeightsPerRewardAllocationIsZero", inputs: [] },
